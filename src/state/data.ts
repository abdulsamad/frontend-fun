...
// Starter project used when no valid local project has been restored.
...
export const defaultFilesData: types.ProjectFile[] = [
  {
    ...
    language: 'html',
    value: `<svg class="logo-svg" viewBox="0 0 279.15 343.95" overflow="visible" stroke="#fff" stroke-width="1" aria-label="Frontend Fun logo" role="img">
